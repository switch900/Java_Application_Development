...
public class CustomerDao extends Dao {
    ...
    public static final String TABLE_NAME = DbConstants.TABLE_ROOT + "Assignment2_Customers";
    ...
    /**
     * Loads database with collection of Customers using CustomerReader class
     * 
    ...
    public void load() throws ApplicationException {
        ...
        try {
            ...
            CustomerReader.readCustomers(customerDataFile, this);
    ...
    public void add(Customer customer) throws SQLException {
        ...
        LOG.debug(String.format("Adding %s was %s", customer, result ? "Unsuccessful" : "Successful"));
    }
    ...
    public void update(Customer customer) throws SQLException {
        ...
        LOG.debug(String.format("Updating %s was %s", customer, result ? "Unsuccessful" : "Successful"));
    }
    ...
    /**
     * Counts all the customers in the database
     * 
     * @return
     *         amount of customers as an int
     * @throws Exception
     *             if data is invalid
     */
