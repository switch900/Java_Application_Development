...
public class CustomerReport {
    ...
    public static void printToConsole(Customer[] customers) {
        ...
        for (Customer customer : customers) {
            System.out.printf(CUSTOMER_FORMAT, ++i, customer.getIdentifier(), customer.getFirstName(), customer.getLastName(), customer.getStreetName(), customer.getCity(), customer.getPostalCode(), customer.getPhoneNumber(), customer.getEmailAddress(), customer.getJoinDate());
        }
    }
